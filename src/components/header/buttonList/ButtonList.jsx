  ...
  return (
    <div className="button_list" style={{position:"fixed"}} id="nav-menu"  >
      <HStack marginLeft={"80%"} mt="2" mr="4" className="button_stack"    >
        ...
        <a href="https://docs.google.com/document/d/1_bWH28nOAnBCozL8CrT66WpHO_9jXLN_xWea7NnGeBc/edit" target="_blank" rel='noreferrer' className="nav-link resume"><button >Resume</button></a>
