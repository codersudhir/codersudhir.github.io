    ...
    <div className="mobile_menu">
      <Menu>
        ...
        <MenuList bg="brand.100" color="white" >
          ...
          <Link to="/skills">
            <MenuItem _focus={{bg:"whitesmoke", color:"black"}} _hover={{bg:"whitesmoke", color:"black"}}>Skills</MenuItem>
          </Link>
          <Link to="/projects">
          ...
          <LinkChakra href="https://docs.google.com/document/d/1_bWH28nOAnBCozL8CrT66WpHO_9jXLN_xWea7NnGeBc/edit" target="_blank">
